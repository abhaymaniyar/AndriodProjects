...
public class Subtraction extends AppCompatActivity {
     ...
     */
    public void checkSubraction(View view) throws InterruptedException {
        ...
        if(ansText.getText().toString().equals("")){
            ...
            Log.d("Firstnumber >>", String.valueOf(firstNumber));
            Log.d("Seocndnumber >>", String.valueOf(secondNumber));
            Log.d("Sub number >>", String.valueOf(firstNumber - secondNumber));
