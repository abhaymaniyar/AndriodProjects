package com.example.android.anagrams_starter;
...
import com.example.android.anagrams_starter.R;

import java.io.IOException;
import java.io.InputStream;
import java.util.ArrayList;

import static com.getbase.floatingactionbutton.R.styleable.FloatingActionButton;
...
public class AnagramsActivity extends AppCompatActivity {
    ...
    private com.example.android.anagrams_starter.AnagramDictionary dictionary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            dictionary = new com.example.android.anagrams_starter.AnagramDictionary(inputStream);
        } catch (IOException e) {
